...
--------------------
This package is part of the master thesis "Development of an Open-Source Python Toolbox for Heart Rate Variability (HRV)" the University of Applied Sciences Hamburg, Germany, PLUX wireless biosignals, S.A., and the Instituto de Telecomunicações.
